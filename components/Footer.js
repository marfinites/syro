...
export default function Footer() {
  return (
    <footer className="mt-12 bg-[#0a0a0a]">
      ...
      <div className="flex flex-col items-center py-12 px-4">
        ...
        {/* Syro Merch Title */}
        <h2 className="text-2xl font-medium text-white mb-4">Syro Merch</h2>
      ...
      {/* Bottom Footer */}
      <div className="border-t border-[#222] py-4 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/refund" className="hover:text-gray-300">Política de reembolso</Link>
